...
public class JwtService {
    ...
    public String generateToken(User user) {
        return Jwts.builder().subject(user.getEmail())
                ...
                .claim("hasMerchants", merchantRepository.existsByUserId(user.getId()))
                .issuedAt(new Date())
    ...
    public Boolean extractHasMerchants(String token) {
        return extractClaims(token).get("hasMerchants", Boolean.class);
    }
